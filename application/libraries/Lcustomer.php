...
class Lcustomer {
	...
	public function customer_edit_data($customer_id)
	{
        ...
        $admin_profile_invoice_data_list = $CI->Customers->admin_profile_invoice_data_list($customer_id);

        $admin_profile_send_data_list = $CI->Customers->admin_profile_send_data_list($customer_id);

        /*echo $customer_id;
        var_dump($admin_profile_send_data_list);
        die();*/

        $data=array(
			'title'			=>display('customer_show'),
