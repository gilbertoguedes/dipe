...
function mf_complemento_notariospublicos10($datos)
{
	...
	if(isset($datos['DatosEnajenante']))
    {
		...
		{
			$datos['DatosEnajenante']['DatosUnEnajenante']['RFC'] = str_replace('&','&amp;', $datos['DatosEnajenante']['DatosUnEnajenante']['RFC']);
		...
		if(isset($datos['DatosEnajenante']['DatosEnajenantesCopSC']))
		{
			...
			{
				$entidad['RFC'] = str_replace('&','&amp;', $entidad['RFC']);
	...
	if(isset($datos['DatosAdquiriente']))
    {
		...
		{
			$datos['DatosAdquiriente']['DatosUnAdquiriente']['RFC'] = str_replace('&','&amp;', $datos['DatosAdquiriente']['DatosUnAdquiriente']['RFC']);
