                            ...
                            <div class="col-sm-8" id="payment_from_2">
                               <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                       <input type="text" name="customer_name_others_address" class=" form-control" placeholder='<?php echo display('address') ?>' id="customer_name_others_address" />
                                    </div>
                                </div> 
                            </div>
                        </div>
                            ...
                            <table class="table table-bordered table-hover" id="normalinvoice">
                                ...
                                <tbody id="addinvoiceItem">
                                    <tr>
                                        ...
                                        <td>
                                            <input type="text" class="form-control text-right unit_1" placeholder="None" readonly="" />
                                        </td>
                                        <td>
...
<!-- Discount calculate end -->
                                ...
                                <tfoot>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-right">
                                            <input type="text" id="invoice_discount" class="form-control text-right" name="invoice_discount" placeholder="0.00" onkeyup="quantity_calculate(1);" onchange="quantity_calculate(1);"/>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        <td align="center" style="width: 220px">
                                            <input type="submit" id="add-invoice" class="btn btn-success" name="add-order" value="<?php echo display('submit') ?>" />
                                        </td>
