...
<div class="content-wrapper">
	<section class="content-header">
	    ...
	    <div class="header-title">
	        ...
	        <small><?php echo display('manage_category_subfamily') ?></small>
	        <ol class="breadcrumb">
	            <li><a href=""><i class="pe-7s-home"></i> <?php echo display('home') ?></a></li>
	            <li><a href="#"><?php echo display('category') ?></a></li>
	            <li class="active"><?php echo display('manage_category_subfamily') ?></li>
	        </ol>
	    </div>
	</section>
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="column">
                  ...
                  <a href="<?php echo base_url('Ccategory/add_category_subfamily')?>" class="btn btn-success m-b-5 m-r-2"><i class="ti-plus"> </i> <?php echo display('add_category_subfamily')?></a>
		        ...
		        <div class="panel panel-bd lobidrag">
		            <div class="panel-heading">
		                <div class="panel-title">
		                    <h4><?php echo display('manage_category_subfamily') ?></h4>
		                </div>
		            </div>
		            <div class="panel-body">
		                <div class="table-responsive">
		                    <table id="dataTableExample2" class="table table-bordered table-striped table-hover">
								<thead>
									<tr>
										<th class="text-center"><?php echo display('category_clave') ?></th>
										<th class="text-center"><?php echo display('subfamily') ?></th>
										<th class="text-center"><?php echo display('family') ?></th>
										<th class="text-center"><?php echo display('department') ?></th>
								...
								?>
									<tr>
										<td class="text-center"><?php echo $category['category_clave']?></td>
										...
										if ($family) {
											$result = $this->db->select('*')
														->from('product_category')
														->where('category_id',$category['parent_category_nivel2'])
														->get()
														->row();
											$department = $result;
											echo ($department->category_name);
										}
										?>	
										</td>
										...
										<td>
											<center>
											<?php echo form_open()?>
												<a href="<?php echo base_url().'Ccategory/category_subfamily_update_form/'.$category['category_id']; ?>" class="btn btn-info btn-sm" data-toggle="tooltip" data-placement="left" title="<?php echo display('update') ?>"><i class="fa fa-pencil" aria-hidden="true"></i></a>
