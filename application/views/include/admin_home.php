        ...
        <div class="row">
            ...
            <!--<div class="col-xs-12 col-sm-6 col-md-6 col-lg-3">
                <div class="panel panel-bd">
                    <div class="panel-body">
                        <div class="statistic-box">
                            <h2><span class="count-number"><?php echo $total_store_invoice ?></span><span class="slight"> <i class="fa fa-play fa-rotate-270 text-warning"> </i> </span></h2>
                            <div class="small"><?php echo display('total_invoice')?></div>
                            <div class="sparkline1 text-center"></div>
                        </div>
                    </div>
...
<script type="text/javascript"> 
    ...
    var myChart = new Chart(ctx, {
        type: 'line',
        data: {
            labels: ["<?php echo display('january')?>", "<?php echo display('february')?>", "<?php echo display('march')?>", "<?php echo display('april')?>", "<?php echo display('may')?>", "<?php echo display('june')?>", "<?php echo display('july')?>","<?php echo display('august')?>","<?php echo display('september')?>","<?php echo display('octobor')?>","<?php echo display('november')?>","<?php echo display('december')?>"],
            datasets: [
                {
