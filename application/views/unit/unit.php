        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="column">
                  ...
                  <a href="<?php echo base_url('Cunit')?>" class="btn btn-success m-b-5 m-r-2"><i class="ti-plus"> </i> <?php echo display('add_unit')?></a>
									...
									<tr>
										...
										<td>
											...
											<?php echo form_open()?>
												...
												<a href="<?php echo base_url().'Cunit/unit_delete/{unit_id}'; ?>" class="btn btn-danger btn-sm" name="{unit_id}" data-toggle="tooltip" data-placement="right" data-original-title="<?php echo display('delete') ?> "><i class="fa fa-trash-o" aria-hidden="true"></i></a>
											<?php echo form_close()?>
											</center>
										</td>
									</tr>
