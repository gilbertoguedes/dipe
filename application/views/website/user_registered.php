                ...
                <div class="row">
                    ...
                    <nav class="col-md-18-24">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="#"><?php echo display('link_user_registered')?></a></li>
...
<section class="section-content1 bg padding-y-sm dipe-section-content">
    <div class="container">
        <div class="card">
            <div class="card-body">
                <h5>Le hemos enviado a su correo electrónico un link de confirmación de usuario, gracias por vitisar nuestro <a href="<?php echo base_url()?>">E-comerce.</a></h5>
            </div> <!-- card-body .// -->
        </div> <!-- card.// -->
    </div>
</section>