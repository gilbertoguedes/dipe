...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <div class="header-title">
            <h1><?php echo display('admin_invoice_data') ?></h1>
            <small><?php echo display('admin_invoice_data') ?></small>
            <ol class="breadcrumb">
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="column">
                    ...
                    <a href="<?php echo base_url('customer/customer_dashboard/add_profile_invoice_data')?>" class="btn btn-info m-b-5 m-r-2"><i class="ti-plus"> </i><?php echo display('add_invoice_data')?></a>
                        ...
                        <div class="table-responsive">
                            <table id="dataTableExample3" class="table table-bordered table-striped table-hover">
                                ...
                                <tr>
                                    ...
                                    <th style="width : 150px; min-width : 150px"><?php echo display('kind_of_person') ?></th>
                                    ...
                                    <tr>
                                        <td>
                                            <center>
                                                ...
                                                <a href="<?php echo base_url().'customer/customer_dashboard/edit_profile_invoice_data/'.$data['customer_information_invoice_data_id'];  ?>" class="btn btn-info btn-sm" data-toggle="tooltip" data-placement="left" title="<?php echo display('update') ?>"><i class="fa fa-pencil" aria-hidden="true"></i></a>

                                                <a href="<?php echo base_url().'customer/customer_dashboard/delete_profile_invoice_data/'.$data['customer_information_invoice_data_id']; ?>" class="btn btn-danger btn-sm" onclick="return confirm('<?php echo display('are_you_sure_want_to_delete')?>');" data-toggle="tooltip" data-placement="right" title="" data-original-title="<?php echo display('delete') ?> "><i class="fa fa-trash-o" aria-hidden="true"></i></a>
