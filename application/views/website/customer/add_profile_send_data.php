...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <div class="header-title">
            <h1><?php echo display('add_data_send') ?></h1>
            <small><?php echo display('add_data_send') ?></small>
            <ol class="breadcrumb">
                <li><a href="#"><i class="pe-7s-home"></i><?php echo display('home') ?></a></li>
                <li><a href="#"><?php echo display('profile') ?></a></li>
                <li class="active"><?php echo display('add_data_send') ?></li>
            </ol>
        </div>
    </section>
    <!-- Main content -->
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="panel panel-bd lobidrag">
                    ...
                    <?php echo form_open_multipart('customer/customer_dashboard/insert_send_data',array('class' => 'form-vertical','id' => 'validate' ))?>
                    <div class="panel-body">
                        <div class="form-group row">
                            <label  class="col-sm-3 col-form-label"><?php echo display('customer_get_data')?> <i class="text-danger">*</i></label>
                            <div class="col-sm-5">
                                <input type="text" placeholder="<?php echo display('names') ?>" class="form-control" id="customer_name" name="customer_name" required />
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-3">
                                <input type="text" placeholder="<?php echo display('street') ?>" class="form-control" id="customer_street" name="customer_street" required/>
                            </div>
                            <label  class="col-sm-1 col-form-label"><?php echo display('between')?> <i class="text-danger">*</i></label>
                            <div class="col-sm-3">
                                <input type="text" placeholder="<?php echo display('between') ?>" class="form-control" id="customer_between1" name="customer_between1" required />
                            </div>
                            <div class="col-sm-2">
                                <input type="text" placeholder="<?php echo display('between') ?>" class="form-control" id="customer_between2" name="customer_between2" required />
                            </div>
                        </div>
                        <div class="form-group row">
                            <label  class="col-sm-3 col-form-label"><?php echo display('exter_number')?> <i class="text-danger">*</i></label>
                            <div class="col-sm-3">
                                <input type="text" placeholder="<?php echo display('exter_number') ?>" class="form-control" id="customer_exter_number" name="customer_exter_number" required />
                            </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-3">
                                <input type="text" placeholder="<?php echo display('colony') ?>" class="form-control" id="customer_colony" name="customer_colony" required />
                            </div>
                            ...
                            <div class="col-sm-3">
                                <input type="text" placeholder="<?php echo display('delegation'); echo " / "; echo display('municipality'); ?>" class="form-control" id="customer_delegation" name="customer_delegation" required />
                            </div>
                        </div>
                        <div class="form-group row">
                            <label  class="col-sm-3 col-form-label"><?php echo display('state');?> <i class="text-danger">*</i></label>
                            <div class="col-sm-3">
                                <input type="text" placeholder="<?php echo display('state') ?>" class="form-control" id="customer_state" name="customer_state" required />
                            </div>
                            <label  class="col-sm-3 col-form-label"><?php echo display('zip'); ?> <i class="text-danger">*</i></label>
                            <div class="col-sm-3">
                                <input type="text" placeholder="<?php echo display('zip'); ?>" class="form-control" id="customer_zip" name="customer_zip" required />
                            </div>
                        </div>
                        <div class="form-group row">
