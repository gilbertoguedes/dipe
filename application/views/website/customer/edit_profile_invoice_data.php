...
<div class="content-wrapper" xmlns="http://www.w3.org/1999/html">
    ...
    <section class="content-header">
        ...
        <div class="header-title">
            <h1><?php echo display('edit_data_invoice') ?></h1>
            <small><?php echo display('edit_data_invoice') ?></small>
            <ol class="breadcrumb">
                <li><a href="#"><i class="pe-7s-home"></i><?php echo display('home') ?></a></li>
                <li><a href="#"><?php echo display('profile') ?></a></li>
                <li class="active"><?php echo display('admin_invoice_data') ?></li>
            </ol>
        </div>
    </section>
    <!-- Main content -->
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="panel panel-bd lobidrag">
                    ...
                    <?php echo form_open_multipart('customer/customer_dashboard/update_invoice_data/{customer_information_invoice_data_id}',array('class' => 'form-vertical','id' => 'validate' ))?>
                    <div class="panel-body">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-5">
                                <select class="form-control" name="customer_variant" id="customer_variant" required>
                                    ...
                                    <option value="1" <?php if($customer_variant=="1") echo "selected";?> ><?php echo display('physics_person')?></option>
                                    <option value="2" <?php if($customer_variant=="2") echo "selected";?> ><?php echo display('morale_person')?></option>
                                </select>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-5">
                                <input type="text" placeholder="<?php echo display('rfc') ?>" class="form-control" id="customer_rfc" name="customer_rfc" value="{customer_rfc}" required />
                            </div>
                        </div>
                        <div id="customer_social_reason" class="form-group row">
                            ...
                            <div class="col-sm-5">
                                <textarea  class="form-control" id="customer_social_reason" name="customer_social_reason"  required />{customer_social_reason}</textarea>
                            </div>
                        </div>
                        <div id="customer_name" class="form-group row">
                            ...
                            <div class="col-sm-5">
                                <input type="text" placeholder="<?php echo display('name') ?>" class="form-control" id="customer_name" name="customer_name" value="{customer_name}" required />
                            </div>
                        </div>
                        <div id="customer_last_name" class="form-group row">
                            ...
                            <div class="col-sm-3">
                                <input type="text" placeholder="<?php echo display('customer_first_lastname') ?>" class="form-control" id="customer_first_lastname"  name="customer_first_lastname" value="{customer_first_lastname}" required />
                            </div>
                            <label  class="col-sm-3 col-form-label"><?php echo display('customer_secon_lastname')?> <i class="text-danger">*</i></label>
                            <div class="col-sm-3">
                                <input type="text" placeholder="<?php echo display('customer_secon_lastname') ?>" class="form-control" id="customer_secon_lastname"  name="customer_secon_lastname" value="{customer_secon_lastname}" required />
                            </div>
                        </div>
                        <!--<div class="form-group row">
